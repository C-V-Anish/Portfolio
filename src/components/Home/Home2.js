        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            Goal oriented, focused Computer Science graduate with an eye for detail.
              <br />
              <br />Proficient in frameworks such as
              <i>
              ...
              <br />
              <br />
              A firm believer of " <b className="purple">Experience without theory is blind, but theory without experience is mere intellectual play.</b> "
            </p>
          </Col>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/C-V-Anish"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/c-v-anish-aa0764220/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/_.cvanish._/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
